...
public class UnityEngine_AnimationStateWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getweight", get_weight);
		L.RegFunction("setweight", set_weight);
		...
		L.RegFunction("getnormalizedTime", get_normalizedTime);
		L.RegFunction("setnormalizedTime", set_normalizedTime);
		...
		L.RegFunction("getnormalizedSpeed", get_normalizedSpeed);
		L.RegFunction("setnormalizedSpeed", set_normalizedSpeed);
