...
public class UnityEngine_CameraWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("gethdr", get_hdr);
		L.RegFunction("sethdr", set_hdr);
		...
		L.RegFunction("getstereoMirrorMode", get_stereoMirrorMode);
		L.RegFunction("setstereoMirrorMode", set_stereoMirrorMode);
