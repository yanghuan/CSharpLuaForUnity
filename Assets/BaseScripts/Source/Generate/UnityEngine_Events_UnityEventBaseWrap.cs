...
internal class UnityEngine_Events_UnityEventBaseWrap
{
	...
	static int GetPersistentEventCount(IntPtr L)
	{
		try
		{
			...
			var obj = (UnityEngine.Events.UnityEventBase)ToLua.CheckObject<UnityEngine.Events.UnityEventBase>(L, 1);
			var o = obj.GetPersistentEventCount();
	...
	static int GetPersistentTarget(IntPtr L)
	{
		try
		{
			...
			var o = obj.GetPersistentTarget(arg0);
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int GetPersistentMethodName(IntPtr L)
	{
		try
		{
			...
			var obj = (UnityEngine.Events.UnityEventBase)ToLua.CheckObject<UnityEngine.Events.UnityEventBase>(L, 1);
			int arg0 = (int)LuaDLL.luaL_checknumber(L, 2);
			var o = obj.GetPersistentMethodName(arg0);
	...
	static int GetValidMethodInfo(IntPtr L)
	{
		try
		{
			...
			var o = UnityEngine.Events.UnityEventBase.GetValidMethodInfo(arg0, arg1, arg2);
