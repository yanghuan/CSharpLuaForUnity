...
internal class UnityEngine_CanvasGroupWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getblocksRaycasts", get_blocksRaycasts);
		L.RegFunction("setblocksRaycasts", set_blocksRaycasts);
		L.RegVar("ignoreParentGroups", get_ignoreParentGroups, set_ignoreParentGroups);
		L.RegFunction("getignoreParentGroups", get_ignoreParentGroups);
		L.RegFunction("setignoreParentGroups", set_ignoreParentGroups);
		L.EndClass();
	}
	...
	static int IsRaycastLocationValid(IntPtr L)
	{
		try
		{
			...
			var obj = (UnityEngine.CanvasGroup)ToLua.CheckObject(L, 1, typeof(UnityEngine.CanvasGroup));
