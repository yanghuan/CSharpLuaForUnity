...
internal class UnityEngine_RectTransformWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("GetLocalCorners0", GetLocalCorners0);
		L.RegFunction("GetLocalCorners1", GetLocalCorners1);
		L.RegFunction("GetWorldCorners", GetWorldCorners);
		L.RegFunction("GetWorldCorners0", GetWorldCorners0);
		L.RegFunction("GetWorldCorners1", GetWorldCorners1);
		...
		L.RegFunction("getanchorMin", get_anchorMin);
		L.RegFunction("setanchorMin", set_anchorMin);
		L.RegVar("anchorMax", get_anchorMax, set_anchorMax);
		L.RegFunction("getanchorMax", get_anchorMax);
		L.RegFunction("setanchorMax", set_anchorMax);
		L.RegVar("anchoredPosition3D", get_anchoredPosition3D, set_anchoredPosition3D);
		L.RegFunction("getanchoredPosition3D", get_anchoredPosition3D);
		L.RegFunction("setanchoredPosition3D", set_anchoredPosition3D);
		L.RegVar("anchoredPosition", get_anchoredPosition, set_anchoredPosition);
		L.RegFunction("getanchoredPosition", get_anchoredPosition);
		L.RegFunction("setanchoredPosition", set_anchoredPosition);
		L.RegVar("sizeDelta", get_sizeDelta, set_sizeDelta);
		L.RegFunction("getsizeDelta", get_sizeDelta);
		L.RegFunction("setsizeDelta", set_sizeDelta);
		...
		L.RegFunction("getoffsetMin", get_offsetMin);
		L.RegFunction("setoffsetMin", set_offsetMin);
		L.RegVar("offsetMax", get_offsetMax, set_offsetMax);
		L.RegFunction("getoffsetMax", get_offsetMax);
		L.RegFunction("setoffsetMax", set_offsetMax);
	...
	static int GetLocalCorners(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
				...
				if(true)return GetLocalCorners0(L);
			else if (count == 2)
			{
				return GetLocalCorners1(L);
			}
			else
			{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetLocalCorners0(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetLocalCorners1(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);

			var obj = (UnityEngine.RectTransform)ToLua.ToObject(L, 1);
	...
	static int GetWorldCorners(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
				...
				if(true)return GetWorldCorners0(L);
			else if (count == 2)
			{
				return GetWorldCorners1(L);
			}
			else
			{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetWorldCorners1(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
