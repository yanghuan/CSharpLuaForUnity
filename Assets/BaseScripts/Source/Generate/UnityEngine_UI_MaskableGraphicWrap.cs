...
internal class UnityEngine_UI_MaskableGraphicWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getonCullStateChanged", get_onCullStateChanged);
		L.RegFunction("setonCullStateChanged", set_onCullStateChanged);
		L.RegVar("maskable", get_maskable, set_maskable);
		L.RegFunction("getmaskable", get_maskable);
		L.RegFunction("setmaskable", set_maskable);
		L.EndClass();
	}
	...
	static int GetModifiedMaterial(IntPtr L)
	{
		try
		{
			...
			var obj = (UnityEngine.UI.MaskableGraphic)ToLua.CheckObject<UnityEngine.UI.MaskableGraphic>(L, 1);
