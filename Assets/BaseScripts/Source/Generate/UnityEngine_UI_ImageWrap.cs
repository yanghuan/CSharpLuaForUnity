...
internal class UnityEngine_UI_ImageWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getoverrideSprite", get_overrideSprite);
		L.RegFunction("setoverrideSprite", set_overrideSprite);
		...
		L.RegFunction("getpreserveAspect", get_preserveAspect);
		L.RegFunction("setpreserveAspect", set_preserveAspect);
		L.RegVar("fillCenter", get_fillCenter, set_fillCenter);
		L.RegFunction("getfillCenter", get_fillCenter);
		L.RegFunction("setfillCenter", set_fillCenter);
		...
		L.RegFunction("getalphaHitTestMinimumThreshold", get_alphaHitTestMinimumThreshold);
		L.RegFunction("setalphaHitTestMinimumThreshold", set_alphaHitTestMinimumThreshold);
		L.RegVar("defaultETC1GraphicMaterial", get_defaultETC1GraphicMaterial, null);
		L.RegFunction("getdefaultETC1GraphicMaterial", get_defaultETC1GraphicMaterial);
		...
		L.RegFunction("gethasBorder", get_hasBorder);
	...
	static int OnBeforeSerialize(IntPtr L)
	{
		try
		{
			...
			var obj = (UnityEngine.UI.Image)ToLua.CheckObject<UnityEngine.UI.Image>(L, 1);
