...
public class UnityEngine_LightWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getshadowRadius", get_shadowRadius);
		L.RegFunction("setshadowRadius", set_shadowRadius);
		L.RegVar("shadowAngle", get_shadowAngle, set_shadowAngle);
		L.RegFunction("getshadowAngle", get_shadowAngle);
		L.RegFunction("setshadowAngle", set_shadowAngle);
		L.EndClass();
	}
