...
internal class UnityEngine_Events_UnityEvent_boolWrap
{
	...
	static int AddListener(IntPtr L)
	{
		try
		{
			...
			var obj = (UnityEngine.Events.UnityEvent<bool>)ToLua.CheckObject<UnityEngine.Events.UnityEvent<bool>>(L, 1);
