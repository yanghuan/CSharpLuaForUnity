...
internal class UnityEngine_UI_InputFieldWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getshouldHideMobileInput", get_shouldHideMobileInput);
		L.RegFunction("setshouldHideMobileInput", set_shouldHideMobileInput);
		...
		L.RegFunction("getcaretBlinkRate", get_caretBlinkRate);
		L.RegFunction("setcaretBlinkRate", set_caretBlinkRate);
		L.RegVar("caretWidth", get_caretWidth, set_caretWidth);
		L.RegFunction("getcaretWidth", get_caretWidth);
		L.RegFunction("setcaretWidth", set_caretWidth);
		L.RegVar("textComponent", get_textComponent, set_textComponent);
		L.RegFunction("gettextComponent", get_textComponent);
		L.RegFunction("settextComponent", set_textComponent);
		L.RegVar("placeholder", get_placeholder, set_placeholder);
		L.RegFunction("getplaceholder", get_placeholder);
		L.RegFunction("setplaceholder", set_placeholder);
		L.RegVar("caretColor", get_caretColor, set_caretColor);
		L.RegFunction("getcaretColor", get_caretColor);
		L.RegFunction("setcaretColor", set_caretColor);
		L.RegVar("customCaretColor", get_customCaretColor, set_customCaretColor);
		L.RegFunction("getcustomCaretColor", get_customCaretColor);
		L.RegFunction("setcustomCaretColor", set_customCaretColor);
		L.RegVar("selectionColor", get_selectionColor, set_selectionColor);
		L.RegFunction("getselectionColor", get_selectionColor);
		L.RegFunction("setselectionColor", set_selectionColor);
		L.RegVar("onEndEdit", get_onEndEdit, set_onEndEdit);
		L.RegFunction("getonEndEdit", get_onEndEdit);
		L.RegFunction("setonEndEdit", set_onEndEdit);
		...
		L.RegFunction("getonValidateInput", get_onValidateInput);
		L.RegFunction("setonValidateInput", set_onValidateInput);
		L.RegVar("characterLimit", get_characterLimit, set_characterLimit);
		L.RegFunction("getcharacterLimit", get_characterLimit);
		L.RegFunction("setcharacterLimit", set_characterLimit);
		L.RegVar("contentType", get_contentType, set_contentType);
		L.RegFunction("getcontentType", get_contentType);
		L.RegFunction("setcontentType", set_contentType);
		L.RegVar("lineType", get_lineType, set_lineType);
		L.RegFunction("getlineType", get_lineType);
		L.RegFunction("setlineType", set_lineType);
		L.RegVar("inputType", get_inputType, set_inputType);
		L.RegFunction("getinputType", get_inputType);
		L.RegFunction("setinputType", set_inputType);
		L.RegVar("touchScreenKeyboard", get_touchScreenKeyboard, null);
		L.RegFunction("gettouchScreenKeyboard", get_touchScreenKeyboard);
		...
		L.RegFunction("getcharacterValidation", get_characterValidation);
		L.RegFunction("setcharacterValidation", set_characterValidation);
		L.RegVar("readOnly", get_readOnly, set_readOnly);
		L.RegFunction("getreadOnly", get_readOnly);
		L.RegFunction("setreadOnly", set_readOnly);
		L.RegVar("multiLine", get_multiLine, null);
		L.RegFunction("getmultiLine", get_multiLine);
		L.RegVar("asteriskChar", get_asteriskChar, set_asteriskChar);
		L.RegFunction("getasteriskChar", get_asteriskChar);
		L.RegFunction("setasteriskChar", set_asteriskChar);
		L.RegVar("wasCanceled", get_wasCanceled, null);
		L.RegFunction("getwasCanceled", get_wasCanceled);
		...
		L.RegFunction("getselectionAnchorPosition", get_selectionAnchorPosition);
		L.RegFunction("setselectionAnchorPosition", set_selectionAnchorPosition);
		L.RegVar("selectionFocusPosition", get_selectionFocusPosition, set_selectionFocusPosition);
		L.RegFunction("getselectionFocusPosition", get_selectionFocusPosition);
		L.RegFunction("setselectionFocusPosition", set_selectionFocusPosition);
	...
	static int MoveTextEnd(IntPtr L)
	{
		try
		{
			...
			var obj = (UnityEngine.UI.InputField)ToLua.CheckObject<UnityEngine.UI.InputField>(L, 1);
