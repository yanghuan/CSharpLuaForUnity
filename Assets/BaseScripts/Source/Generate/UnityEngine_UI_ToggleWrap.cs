...
internal class UnityEngine_UI_ToggleWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getgroup", get_group);
		L.RegFunction("setgroup", set_group);
		L.RegVar("isOn", get_isOn, set_isOn);
		L.RegFunction("getisOn", get_isOn);
		L.RegFunction("setisOn", set_isOn);
		L.EndClass();
	}
	...
	static int Rebuild(IntPtr L)
	{
		try
		{
			...
			var obj = (UnityEngine.UI.Toggle)ToLua.CheckObject<UnityEngine.UI.Toggle>(L, 1);
