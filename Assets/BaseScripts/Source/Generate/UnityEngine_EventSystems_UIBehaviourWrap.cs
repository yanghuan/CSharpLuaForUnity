...
internal class UnityEngine_EventSystems_UIBehaviourWrap
{
	...
	static int IsActive(IntPtr L)
	{
		try
		{
			...
			var obj = (UnityEngine.EventSystems.UIBehaviour)ToLua.CheckObject<UnityEngine.EventSystems.UIBehaviour>(L, 1);
			var o = obj.IsActive();
