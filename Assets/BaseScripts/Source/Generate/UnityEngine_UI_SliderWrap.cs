...
internal class UnityEngine_UI_SliderWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getfillRect", get_fillRect);
		L.RegFunction("setfillRect", set_fillRect);
		...
		L.RegFunction("setminValue", set_minValue);
		L.RegVar("maxValue", get_maxValue, set_maxValue);
		L.RegFunction("getmaxValue", get_maxValue);
		L.RegFunction("setmaxValue", set_maxValue);
		L.RegVar("wholeNumbers", get_wholeNumbers, set_wholeNumbers);
		L.RegFunction("getwholeNumbers", get_wholeNumbers);
		L.RegFunction("setwholeNumbers", set_wholeNumbers);
		...
		L.RegFunction("getnormalizedValue", get_normalizedValue);
		L.RegFunction("setnormalizedValue", set_normalizedValue);
	...
	static int Rebuild(IntPtr L)
	{
		try
		{
			...
			var obj = (UnityEngine.UI.Slider)ToLua.CheckObject<UnityEngine.UI.Slider>(L, 1);
