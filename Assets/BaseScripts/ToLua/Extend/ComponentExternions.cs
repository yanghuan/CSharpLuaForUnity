...
namespace Generic
{
    public static class ComponentExternions
    {
        ...
        public static Component GetComponentInParent0T(this UnityEngine.Component self, System.Type T)
        {
            return self.GetComponentInParent(T);
        }

        public static Component[] GetComponentsInParent0T(this UnityEngine.Component self, System.Type T)
        {
            return self.GetComponentsInParent(T);
        }

        public static Component[] GetComponentsInParent1T(this UnityEngine.Component self, System.Boolean includeInactive, System.Type T)
        {
