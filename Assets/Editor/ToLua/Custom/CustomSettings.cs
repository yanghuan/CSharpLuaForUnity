...
{
    public static string saveDir = Application.dataPath + CSharpLua.Settings.Paths.kLuaRuntimeScriptsDir + "/Source/Generate/";    
    public static string toluaBaseType = Application.dataPath + CSharpLua.Settings.Paths.kLuaRuntimeScriptsDir + "/ToLua/BaseType/";    
